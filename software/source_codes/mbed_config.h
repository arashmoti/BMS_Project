...
#define MBED_CONF_APP_LED_OFF                                                 1                                                                                                // set by application[NUCLEO_G474RE]
#define MBED_CONF_APP_LED_ON                                                  0                                                                                                // set by application[NUCLEO_G474RE]
#define MBED_CONF_APP_LED_PIN                                                 LED1                                                                                             // set by application[NUCLEO_G474RE]
#define MBED_CONF_APP_PRESENT                                                 1                                                                                                // set by application
#define MBED_CONF_APP_USER_BUTTON                                             BUTTON1                                                                                          // set by application[NUCLEO_G474RE]
